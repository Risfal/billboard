...
<div class="page-wrapper">
	...
	<section class="hero-section">
		{#if animate}
			<div class="card-container" in:fly={{ y: 40, duration: 1000 }}>
...
<style>
	...
	.card-container {
		--electric-border-color: #bb9af7; /* Tokyonight Purple */
		--electric-light-color: #9d7cd8; /* Lighter Purple Variant */
		--gradient-color: rgba(187, 154, 247, 0.2);
		--color-neutral-900: #1a1b26; /* Match Page Background */
	...
	.subtitle {
		...
		font-size: 1.2rem;
		font-weight: 700; /* Bumped to 700 since Atkinson only supports 400 or 700 */
		color: #7aa2f7;
		margin: 0;
	}
	...
	@media (max-width: 768px) {
		.content-top {
			padding: 80px 32px 24px 32px; /* Increased mobile top padding */
		}
		.content-bottom {
